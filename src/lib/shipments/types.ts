...
export type ShipmentError = { code: "NOT_FOUND" | "INCOMPATIBLE_FACILITY" | "FACILITY_UNAVAILABLE" | "WASTE_LOT_NOT_ELIGIBLE" | "INVALID_SHIPMENT_STATE" | "NO_ROUTE" | "NETWORK_ERROR" | "INVALID_RESPONSE" | "INVALID_COORDINATES" | "UNSUPPORTED_CARBON_COEFFICIENT" | "UNSUPPORTED_ECONOMIC_COEFFICIENT"; message: string };
